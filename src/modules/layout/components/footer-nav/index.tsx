    ...
    <div className="flex flex-col pb-8 content-container gap-y-8">
      <div className="pt-24 overflow-hidden bg-white">
        <div className="container px-4 mx-auto">
                  ...
                  <div className="inline-block w-full mb-3 overflow-hidden border border-gray-300 xl:pl-6 md:max-w-xl rounded-xl focus-within:ring focus-within:ring-indigo-300">
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="w-full xl:w-auto">
                        <div className="block">
                          <button
                            className="w-full px-8 py-4 font-semibold text-white transition duration-200 ease-in-out bg-pink-600 border border-pink-600 focus:ring-pink-600 hover:bg-slate-800"
                            type="button"
                          >
                            Subscribe
                          </button>
          ...
          <div className="flex flex-wrap pt-6 -m-4 justify-items-center">
            <div className="flex items-center justify-center w-full p-4 ">
              <div className="flex flex-wrap -m-4">
                <div className="w-auto p-4">
                <a className="text-blueGray-400 hover:text-pink-700" href="#">
                    <svg
                      width={9}
                      height={16}
                      viewBox="0 0 9 16"
